 ...
 " role="dialog" tabIndex="-1" aria-label="Sidebar">
                <div className="relative flex flex-col h-full max-h-full">
                    <div className="px-6 pt-4 flex items-center">
                        {/* Logo */}
                        <a className="flex-none text-white rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="#" aria-label="Preline">
                            LOGO
                        </a>
                        {/* End Logo */}
                ...
                <div className="p-4 sm:p-6 space-y-4 space-x-3 sm:space-y-6 grid md:grid-cols-2">
                    ...
                    <div className='space-y-10 flex  justify-around flex-col'>
                        ...
                        <div className="relative border border-gray-200 rounded-full">
                            <input type="text" className="p-3 sm:p-4 block w-full border-gray-200 text-white  rounded-full sm:text-md focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Ask me anything..." />
...
<div className="grid grid-cols-2 sm:grid-cols-3 gap-2 p-4">
  ...
  <a className="group  relative overflow-hidden flex justify-center items-center" href="#">
      <div className="flex items-center gap-x-1 py-1 rounded-[100%] px-2 w-[100px] h-[100px] bg-gray-800 border border-none text-gray-800">
